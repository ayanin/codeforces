package codeforces.archieve.c236;
...
public class A {
    public static void solve() {
        String nickname = FS.next();
        Set<String> uniqChars = new HashSet<String>();

        for (int i = 0; i < nickname.length(); i++) {
            uniqChars.add(nickname.substring(i, i + 1));
        }

        FS.pt.println(uniqChars.size() % 2 != 0 ? "IGNORE HIM!" : "CHAT WITH HER!");
    }
