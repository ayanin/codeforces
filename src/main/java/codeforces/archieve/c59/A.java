package codeforces.archieve.c59;
...
public class A {
    public static void solve() {
        int MIN_LOWERCASE_CHAR = 97;
        int MAX_LOWERCASE_CHAR = 122;
        int numberOfLowercaseChars = 0;
        int numberOfUppercaseChars = 0;
        String s = FS.next();

        for (int i = 0; i < s.length(); i++) {
            int currenctCharCode = (int) s.charAt(i);

            if (currenctCharCode >= MIN_LOWERCASE_CHAR && currenctCharCode <= MAX_LOWERCASE_CHAR) {
        ...
        if (numberOfUppercaseChars > numberOfLowercaseChars) {
            s = s.toUpperCase();
        } else {
            s = s.toLowerCase();
        }
